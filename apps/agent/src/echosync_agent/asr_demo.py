...
def build_transcriber(args: argparse.Namespace) -> Transcriber:
    ...
    return build_transcriber_from_settings(
        Settings(
            ...
            elevenlabs_optimize_streaming_latency=settings.elevenlabs_optimize_streaming_latency,
            ...
            funasr_vad_activation_threshold=settings.funasr_vad_activation_threshold,
